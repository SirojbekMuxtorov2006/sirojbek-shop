...
import Logo from '../../../public/sirojbek-shop.png'

const Hero = () => {
  return (
    <section className="text-gray-600 body-font relative top-10">
      <div className="container mx-auto flex px-1 py-7 md:flex-row flex-col items-center">
